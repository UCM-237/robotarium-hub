...
/*
const int PIN_LEFT = 2; // Arduino MKR and Arduino Nano 33IoT
const int PIN_RIGHT = 3 ;//Arduino MKR and Arduino Nano 33IoT
*/

const int PIN_LEFT = 1; // Arduino MKR and Arduino Nano 33IoT
const int PIN_RIGHT = 4 ;//Arduino MKR and Arduino Nano 33IoT
...
const int             encoderLeft =             PIN_LEFT;//pin de entrada de encoder derecha
const int             encoderRight=             PIN_RIGHT;//pin de entrada de encoder izquierda
...
unsigned long              TIMEDEBOUNCE        =12; //(ms) es el tiempo minimo entre pulsos
