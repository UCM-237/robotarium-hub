...
const unsigned long TESTTIME = 1000;
unsigned int test_case=0, contador=0;
    ...
    Serial.println(wLeft);
      ...
      switch(test_case){
        case 0: 
              ...
              break;
        case 1:
              // STEP 2: Rueda izquierda a tope
              wheelControlerRight.setSetPoint(0);
              wheelControlerLeft.setSetPoint(10);
...
void onMqttMessage(int messageSize){
  ...
  String topic_recibido= mqttClient.messageTopic();
  Serial.print(" Tamaño: ");
